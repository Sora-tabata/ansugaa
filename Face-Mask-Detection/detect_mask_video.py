...
def showimage():
	...
	if (emo=='awa'):
		folder_path = './images_folder/aware/'
	elif (emo=='yor'):
		folder_path = './images_folder/yorokobi/'
	elif (emo=='ika'):
		folder_path = './images_folder/ikari/'
	elif (emo=='kow'):
		folder_path = './images_folder/kowagari/'
	elif (emo=='haj'):
		folder_path = './images_folder/haji/'
	elif (emo=='suk'):
		folder_path = './images_folder/suki/'
	elif (emo=='iya'):
		folder_path = './images_folder/iya/'
	elif (emo=='tak'):
		folder_path = './images_folder/takaburi/'
	elif (emo=='yas'):
		folder_path = './images_folder/yasuragi/'
	elif (emo=='odo'):
		folder_path = './images_folder/odoroki/'
	elif(emo=='nor'):
		folder_path = './images_folder/normal/'
	else:
		folder_path = './images_folder/flat/'
...
while True:
	...
	frame = vs.read()
	frame = imutils.resize(frame, height=1690, width=1280)
